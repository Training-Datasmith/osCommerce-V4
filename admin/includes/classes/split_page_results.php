...
class splitPageResults
{
   ...
   */
    public function __construct(&$current_page_number, $max_rows_per_page, &$sql_query, &$query_num_rows, $count_key = '*')
    {
    ...
    public function display_links_ex($max_page_links, $parameters = '', $page_name = 'page')
    {
    ...
    public function display_count_ex($text_output)
    {
