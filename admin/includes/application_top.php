...
if (!isset($PHP_SELF)) {
    $PHP_SELF = preg_replace('/.php/i', '', $_SERVER['PHP_SELF']);
}
$pos = strpos($PHP_SELF, '?');
if ($pos !== false) {
...
$cache_blocks = [['title' => defined('TEXT_CACHE_CATEGORIES') ? TEXT_CACHE_CATEGORIES : 'TEXT_CACHE_CATEGORIES', 'code' => 'categories', 'file' => 'categories_box-language.cache', 'multiple' => true],
                      ['title' => defined('TEXT_CACHE_MANUFACTURERS') ? TEXT_CACHE_MANUFACTURERS : 'TEXT_CACHE_MANUFACTURERS', 'code' => 'manufacturers', 'file' => 'manufacturers_box-language.cache', 'multiple' => true],
                      ['title' => defined('TEXT_CACHE_ALSO_PURCHASED') ? TEXT_CACHE_ALSO_PURCHASED : 'TEXT_CACHE_ALSO_PURCHASED', 'code' => 'also_purchased', 'file' => 'also_purchased-language.cache', 'multiple' => true],
                     ];
$tax_rates_array = [];
/*
// mysql error
