...
class Quote
{
    ...
    public static function get_status_group()
    {
    ...
    public static function get_status_groups()
    {
    ...
    {
        $order_status_query = tep_db_query('SELECT orders_status_id FROM ' . TABLE_ORDERS_STATUS . " WHERE orders_status_name = '" . $name . "' AND orders_status_groups_id IN (" . implode(',', self::get_status_groups()) . ')');
        $order_status = tep_db_fetch_array($order_status_query);
