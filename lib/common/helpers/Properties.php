...
class Properties
{
    ...
    public static function generate_properties_tree($parent_id = '0', $properties_array = [], $values_array = [], $properties_tree_array = '', $throughoutID = '', $val_extra = [])
    {
        global $languages_id;
        ...
        while ($properties = tep_db_fetch_array($properties_query)) {
            if (/* count($properties_array) == 0 || */self::is_property_in_array($properties['properties_id'], $properties_array)) {
                ...
                $properties_tree_array[$properties['properties_id']] = [
