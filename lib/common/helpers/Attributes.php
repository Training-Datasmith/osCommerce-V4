...
class Attributes
{
     ...
     */
    public static function getDetails($products_id, &$attributes, $params = [])
    {
    ...
    public static function get_attributes_prices($attributes_id, $_tax = 0)
    {
        ...
        while ($data = tep_db_fetch_array($data_query)) {
            ...
            $data['qty_discounts'] = [];
            $tmp = \common\helpers\Product::parseQtyDiscountArray($data['products_attributes_discount_price']);
