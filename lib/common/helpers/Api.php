...
class Api
{
    ...
    public static function getDepartmentServerKeyValue($departmentId, $keyName)
    {
        $value = null;
    ...
    public static function setDepartmentServerKeyValue($departmentId, $keyName, $value)
    {
        tep_db_query(
    ...
    public static function updateCustomerModifyTime($customerId = null)
    {
        tep_db_query(
    ...
    public static function allowApiCreateCategory($departmentId)
    {
    ...
    public static function allowApiUpdateCategory($departmentId)
    {
        $check = tep_db_fetch_array(tep_db_query(
            'SELECT COUNT(*) AS c '.
            'FROM ' . TABLE_DEPARTMENTS . ' '.
    ...
    public static function allowApiCreateProduct($departmentId)
    {
        $check = tep_db_fetch_array(tep_db_query(
            'SELECT COUNT(*) AS c '.
            'FROM ' . TABLE_DEPARTMENTS . ' '.
    ...
    public static function allowApiUpdateProduct($departmentId)
    {
        $check = tep_db_fetch_array(tep_db_query(
            'SELECT COUNT(*) AS c '.
            'FROM ' . TABLE_DEPARTMENTS . ' '.
    ...
    public static function allowApiRemoveProduct($departmentId)
    {
        $check = tep_db_fetch_array(tep_db_query(
            'SELECT COUNT(*) AS c '.
            'FROM ' . TABLE_DEPARTMENTS . ' '.
