...
class Country
{
    public static function new_get_countries($default = '', $showDisabled = true)
    {
        ...
        while ($countries = tep_db_fetch_array($countries_query)) {
            if (!$showDisabled && !self::checkPlatformCountry($countries['countries_id'], null, 'ship') && !self::checkPlatformCountry($countries['countries_id'], null, 'bill')) {
                continue;
            }
