...
class CustomersBasketAttributes extends ActiveRecord
{
    ...
    public static function hasGiftWrapAttribute($products_id, $customer_id, $basket_id)
    {
        return self::find()->where(
            'customers_id = :cid and products_id =:prid and products_options_id = "gift_wrap" and basket_id=:bid',
            [':cid' => (int)$customer_id, ':prid' => tep_db_input($products_id), ':bid' => $basket_id]
        )->count();
    }
