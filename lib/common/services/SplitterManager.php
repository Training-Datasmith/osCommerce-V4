...
class SplitterManager
{
    ...
    public const STATUS_RETURNING = 3;
    public const STATUS_RETURNED = 4;
    public const OWNER_CUSTOMER = 1; //splinters_type
    public const OWNER_DELIVERY = 2;
    public const OWNER_BILLING = 3;
    public const OWNER_INFO = 4;
    public const OWNER_PRODUCT = 5;
    public const OWNER_TOTAL = 6;
    public const OWNER_MIXED = 7;
