...
class zones extends ModuleShipping
{
    ...
    public function quote($method = '')
    {
        ...
        $this->quotes = ['id' => $this->code,
                              ...
                              'methods' => [['id' => $dest_zone ? $dest_zone : $this->code,
    ...
    public function configure_keys()
    {
        $config =  [
          ...
          'MODULE_SHIPPING_ZONES_TAX_CLASS' =>
             [
              ...
              'MODULE_SHIPPING_ZONES_DATE_SETTING' =>  [
              ...
              'MODULE_SHIPPING_ZONES_DISABLED_DAYS' =>  [
        ...
        for ($i = 1; $i <= $this->num_zones; $i++) {
            ...
            $config['MODULE_SHIPPING_ZONES_HANDLING_'.$i] = [
