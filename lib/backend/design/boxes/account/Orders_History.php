...
use yii\base\Widget;
class Orders_History extends Widget
{
    public $id;
    public $params;
    public $settings;
    ...
    public function run()
    {
        ...
        return $this->render('../../views/account/orders-history.tpl', ['id' => $this->id, 'params' => $this->params, 'settings' => $this->settings, 'visibility' => $this->visibility, 'links' => $links]);
    }
}