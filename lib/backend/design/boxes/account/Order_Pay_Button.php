...
use yii\base\Widget;
class Order_Pay_Button extends Widget
{
    public $id;
    public $params;
    public $settings;
    ...
    public function run()
    {
        ...
        return $this->render('../../views/account/account-link.tpl', ['id' => $this->id, 'params' => $this->params, 'settings' => $this->settings, 'visibility' => $this->visibility, 'links' => $links]);
    }
}