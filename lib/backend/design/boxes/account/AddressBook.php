...
use yii\base\Widget;
class Address_Book extends Widget
{
    public $id;
    public $params;
    public $settings;
    ...
    public function run()
    {
        ...
        return $this->render('../../views/account/address-book.tpl', ['id' => $this->id, 'params' => $this->params, 'settings' => $this->settings, 'visibility' => $this->visibility, 'links' => $links]);
    }
}