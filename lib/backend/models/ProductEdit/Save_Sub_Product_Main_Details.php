...
use yii;
class Save_Sub_Product_Main_Details
{
    protected $product;
    ...
    {
        $parent_model = \common\models\Products::find_one($this->product->parent_products_id);
        $parent_data = $parent_model->get_attributes();
        $sql_data_array = [];
        // {{
