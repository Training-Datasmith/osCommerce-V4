                ...
                if (is_array($buy_qty[$group_id]) && array_sum($buy_qty[$group_id]) > 0) { //exists buy value
                    ...
                    if (USE_MARKET_PRICES == 'True') {
                        if (\common\helpers\Extensions::isCustomerGroupsAllowed()) {
                            ...
                            foreach ($shopping_cart_price[$group_id] as $currencies_id => $price) {
                                ...
                                $sql_data_array = [
                                    ...
                                    'shopping_cart_price' => (float) $shopping_cart_price[$group_id][$currencies_id],
                                    'buy_qty' => 0,
                            ...
                            foreach ($shopping_cart_price as $currencies_id => $price) {
                                ...
                                $sql_data_array = [
                                    ...
                                    'shopping_cart_price' => (float) $shopping_cart_price[$currencies_id],
                                    'buy_qty' => 0,
                        ...
                        $sql_data_array = [
                            ...
                            'shopping_cart_price' => (float) $shopping_cart_price[$group_id],
                            'buy_qty' => 0,
