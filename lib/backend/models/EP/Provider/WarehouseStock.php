...
class WarehouseStock extends ProviderAbstract implements ImportInterface, ExportInterface
{
    ...
    protected function initFields()
    {
        ...
        $this->fields[] = ['name' => 'products_model', 'value' => 'Inventory Model', 'calculated' => true, /*'is_key_part'=>true*/];
        /*
        ...
        */
        $this->fields[] = ['name' => 'supplier', 'value' => 'Supplier', 'calculated' => true,'get' => 'get_supplier', 'set' => 'set_supplier', /*'is_key_part'=>true*/];
