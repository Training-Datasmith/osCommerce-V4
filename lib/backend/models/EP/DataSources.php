...
class DataSources
{
    ...
    private static function findAvailable(array $condition)
    {
    ...
    public static function getActiveByClass($name)
    {
        $datasources = [];
    ...
    public static function orderView($orderId)
    {
        if (empty($orderId)) {
            return [];
        }
    ...
    public static function orderViewExport($orderId)
    {
        if (empty($orderId)) {
            return [];
        }
