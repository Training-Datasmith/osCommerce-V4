...
class MenusController extends Sceleton
{
    ...
    public const MENU_CATEGORIES_MAX_LEVEL = -1; //-1 - no restriction, starts from 1
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['design_controls', 'menus'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('menus/index'), 'title' => HEADING_TITLE];
        ...
        $default_pages = [
          ['type_id' => 8888886, 'name' => TEXT_HOME, 'opt_need_login' => false],
          ['type_id' => 8888888, 'name' => TEXT_MY_ACCOUNT . ' / ' . TEXT_MY_ACCOUNT, 'opt_need_login' => false],
          ['type_id' => 8888887, 'name' => TEXT_SIGN_IN . ' / ' . TEXT_HEADER_LOGOUT, 'opt_need_login' => false],
          ['type_id' => 8888884, 'name' => TEXT_CHECKOUT, 'opt_need_login' => false],
          ['type_id' => 8888883, 'name' => TEXT_SHOPPING_CART, 'opt_need_login' => false],
          ['type_id' => 8888882, 'name' => IMAGE_NEW_PRODUCT, 'opt_need_login' => true],
          ['type_id' => 8888881, 'name' => BOX_CATALOG_FEATURED, 'opt_need_login' => true],
          ['type_id' => 8888880, 'name' => TEXT_SPECIALS_PRODUCTS, 'opt_need_login' => true],
          ['type_id' => 8888879, 'name' => TEXT_GIFT_CARD, 'opt_need_login' => false],
          ['type_id' => 8888878, 'name' => TEXT_ALL_PRODUCTS, 'opt_need_login' => true],
          ['type_id' => 8888877, 'name' => TEXT_SITE_MAP, 'opt_need_login' => true],
          ['type_id' => 8888876, 'name' => BOX_PROMOTIONS, 'opt_need_login' => false],
          ['type_id' => 8888875, 'name' => TEXT_WEDDING_REGISTRY, 'opt_need_login' => false],
          ['type_id' => 8888874, 'name' => MANAGE_YOUR_WEDDING_REGISTRY, 'opt_need_login' => false],
          ['type_id' => 8888873, 'name' => TEXT_QUICK_ORDER, 'opt_need_login' => false],
        ];
