...
class CountriesController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['settings', 'locations', 'countries'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('countries/index'), 'title' => HEADING_TITLE];

        $this->view->headingTitle = HEADING_TITLE;
        $this->topButtons[] = '<a href="#" class="btn btn-primary" onclick="return countryEdit(0)">'.IMAGE_INSERT.'</a>';

        $this->view->countriesTable = [
            [
