...
class AdminaccountController extends Sceleton
{
    ...
    {
        $this->selectedMenu = ['administrator', 'adminaccount'];
        $this->navigation[] = ['link' => \Yii::$app->urlManager->createUrl('adminaccount/index'), 'title' => HEADING_TITLE];
    ...
    public function actionHideLanguage()
    {
    ...
    public function actionAdminaccountactions()
    {
        $this->layout = false;
    ...
    public function getAdminObj($admin_id)
    {
    ...
    public function actionSaveaccount()
    {
        ...
        if (is_array($myAccount)) {
            $mInfo = new \objectInfo($myAccount);
        }
    ...
    public function actionNameform()
    {
        $this->layout = false;
        ...
        $html = '<div id="accountpopup">' . tep_draw_form('save_account_form', 'adminaccount', \common\helpers\Output::get_all_get_params(['action']) . 'action=update', 'post', 'id="save_account_form" onSubmit="return saveAccount();"') . tep_draw_hidden_field('admin_id', $myAccount['admin_id']) . tep_draw_hidden_field('popupname', 'name');
    ...
    public function actionEmailform()
    {
        ...
        $html = '<div id="accountpopup">' . tep_draw_form('save_account_form', 'adminaccount', \common\helpers\Output::get_all_get_params(['action']) . 'action=update', 'post', 'id="save_account_form" onSubmit="return saveAccount();"') . tep_draw_hidden_field('admin_id', $myAccount['admin_id']) . tep_draw_hidden_field('popupname', 'email');
        $html .= '<table cellspacing="0" cellpadding="0" width="100%">
                <tr>
    ...
    public function actionPasswordform()
    {
        ...
        return $this->renderPartial('password-form.tpl', [
            ...
            'action' => \common\helpers\Output::get_all_get_params(['action']) . 'action=update',
        ]);
    }
    ...
    public function actionChangeavatar()
    {
        ...
        $login_id = (int) tep_session_var('login_id');
        $myAccount = $this->getAdminObj($login_id);
        $html = '<div id="accountpopup">' . tep_draw_form('save_account_form', 'adminaccount', \common\helpers\Output::get_all_get_params(['action']) . 'action=update', 'post', 'id="save_account_form" onSubmit="return saveAccount();"') . tep_draw_hidden_field('admin_id', $myAccount['admin_id']) . tep_draw_hidden_field('popupname', 'avatar');
    ...
    public function actionGetpassword()
    {
        ...
        $login_id = (int) tep_session_var('login_id');
        $myAccount = $this->getAdminObj($login_id);
        $html = '<div id="accountpopup">' . tep_draw_form('check_pass_form', 'adminaccount', \common\helpers\Output::get_all_get_params(['action']) . 'action=update', 'post', 'id="check_pass_form" onSubmit="return checkPassword();"') . tep_draw_hidden_field('admin_id', $myAccount['admin_id']);
        $html .= '<table cellspacing="0" cellpadding="0" width="100%">
							<tr>
    ...
    public function actionUsernameform()
    {
        $this->layout = false;
        $this->view->usePopupMode = true;
        ...
        $html = '<div id="accountpopup">' . tep_draw_form('save_account_form', 'adminaccount', \common\helpers\Output::get_all_get_params(['action']) . 'action=update', 'post', 'id="save_account_form" onSubmit="return saveAccount();"') . tep_draw_hidden_field('admin_id', $myAccount['admin_id']) . tep_draw_hidden_field('popupname', 'admin_username');
        $html .= '<table cellspacing="0" cellpadding="0" width="100%">
					<tr>
    ...
    public function actionCustomerform()
    {
        ...
        $html = '<div id="accountpopup">' . tep_draw_form('save_account_form', 'adminaccount', \common\helpers\Output::get_all_get_params(['action']) . 'action=update', 'post', 'id="save_account_form" onSubmit="return saveAccount();"') . tep_draw_hidden_field('admin_id', $myAccount['admin_id']) . tep_draw_hidden_field('popupname', 'customers_id');
        $html .= '<table cellspacing="0" cellpadding="0" width="100%">
					<tr>
    ...
    public function actionSelectCustomerForm()
    {
        $this->layout = false;
        $this->view->usePopupMode = true;
        $login_id = (int) tep_session_var('login_id');
    ...
    public function actionSelectPosPlatformForm()
    {
        $this->layout = false;
        $this->view->usePopupMode = true;
        $login_id = (int) tep_session_var('login_id');
    ...
    public function actionSelectPosCurrencyForm()
    {
        $this->layout = false;
        $this->view->usePopupMode = true;
        $login_id = (int) tep_session_var('login_id');
    ...
    public function actionGetpin()
    {
        ...
        $login_id = (int) tep_session_var('login_id');
        $myAccount = $this->getAdminObj($login_id);
        $html = '<div id="accountpopup">' . tep_draw_form('save_account_form', 'adminaccount', \common\helpers\Output::get_all_get_params(['action']) . 'action=update', 'post', 'id="save_account_form" onSubmit="return saveAccount();"') . tep_draw_hidden_field('admin_id', $myAccount['admin_id']) . tep_draw_hidden_field('popupname', 'pin');
        $html .= '<table cellspacing="0" cellpadding="0" width="100%">
					<tr>
