...
class Orders_status_groupsController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['settings', 'status', 'orders_status_groups'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('orders_status_groups/index'), 'title' => HEADING_TITLE];
    ...
    public function actionSave()
    {
        ...
        for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
            ...
            if ($orders_status_groups_id == 0) {
                $insert_sql_data = ['orders_status_groups_id' => $insert_id,
                ...
                if (!$check['orders_status_groups_exists']) {
                    $insert_sql_data = ['orders_status_groups_id' => $orders_status_groups_id,
                                             'language_id' => $language_id];
                    $sql_data_array = array_merge($sql_data_array, $insert_sql_data);
