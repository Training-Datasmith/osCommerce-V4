...
class StocktakingCostController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['reports', 'stocktaking-cost'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('stocktaking-cost/index'), 'title' => BOX_REPORTS_STOCK_COST];
        ...
        foreach ($result as $products) {
            ...
            if (in_array('prod', $this->groupby) && $products['products_id'] != $products['uprid']) {
                ...
                if (!isset($ttls['prod'][$products['products_id']])) {
                    ...
                    $ttls['prod'][$products['products_id']] = array_merge(
                        $products,
