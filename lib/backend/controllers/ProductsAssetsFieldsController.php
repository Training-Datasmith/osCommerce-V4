...
class ProductsAssetsFieldsController extends Sceleton
{
    ...
    {
        $this->selectedMenu = ['catalog', 'products-assets-fields'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('products-assets-fields/index'), 'title' => HEADING_TITLE];
        ...
        $this->view->productsAssetsFieldTable = [
            [
        ...
        return $this->render('index', ['messages' => $messages, 'pafID' => $pafID]);
    }
