...
class WarehousesController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['catalog', 'warehouses'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('warehouses/index'), 'title' => HEADING_TITLE];
    ...
    public function actionEdit()
    {
        ...
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('warehouses/'), 'title' => $text_new_or_edit . ' ' . ($pInfo->warehouses_name ?? null)];
        $this->selectedMenu = ['catalog', 'warehouses'];
    ...
    public function actionLocations()
    {
        ...
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('warehouses/locations'), 'title' => IMAGE_EDIT . ' ' . TEXT_WAREHOUSE_LOCATIONS . ': ' . $warehouse->warehouse_name];
    ...
    public function actionLocationBlocks()
    {
        ...
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('warehouses/location-blocks'), 'title' => TEXT_MANAGE_LOCATION_BLOCKS];
