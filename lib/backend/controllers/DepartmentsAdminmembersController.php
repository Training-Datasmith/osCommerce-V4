...
class DepartmentsAdminmembersController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['departments', 'departments-adminmembers'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('departments-adminmembers/'), 'title' => HEADING_TITLE];
    ...
    public function actionAdminedit()
    {
        ...
        <?php
        echo tep_draw_form('admin', 'departments-adminmembers', \common\helpers\Output::get_all_get_params(['action']) . 'action=update', 'post', 'id="admin_edit" onSubmit="return check_form();"') .
    ...
    public function actionOverridePermissions()
    {
        ...
        $this->selectedMenu = ['departments', 'departments-adminmembers'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('departments-adminmembers/index'), 'title' => HEADING_TITLE];
        $this->view->headingTitle = HEADING_TITLE;
