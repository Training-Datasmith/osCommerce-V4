...
class Meta_tagsController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['seo_cms', 'meta_tags'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('meta_tags/'), 'title' => HEADING_TITLE];
