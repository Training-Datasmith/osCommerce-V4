...
class LanguagesController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['settings', 'localization', 'languages'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('currencies/index'), 'title' => HEADING_TITLE];
    ...
    public function actionEdit()
    {
        ...
        if (!empty($lang['locale'])) {
            ...
            if (!$list_contain_locale) {
                $lList[] = ['id' => $lang['locale'], 'text' => $lang['locale']];
            }
        }
    ...
    public function actionPredefine()
    {
        ...
        Yii::$app->controller->view->predefinedTable = [
            [
        ...
        if (Yii::$app->request->isPost && isset($_POST['action']) && $_POST['action'] == 'predefine') {
            ...
            if ($_languages_id) {
                ...
                if (isset($data['language_data_id'])) {
                    ...
                    $sql_array = ['code' => strtolower($data['language_code']),
                        'image_svg' => $data['icon'],
