...
class OrdersCommentTemplateController extends Sceleton
{
    ...
    {
        $this->selectedMenu = ['settings', 'status', 'orders-comment-template'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('orders-comment-template/index'), 'title' => HEADING_TITLE];
