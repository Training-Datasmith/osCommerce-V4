...
class Information_managerController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['design_controls', 'information_manager'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('information_manager/index'), 'title' => MANAGER_INFORMATION];
    ...
    public function actionCreate()
    {
        ...
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('information_manager/edit'), 'title' => TEXT_ADD_NEW_PAGE];
    ...
    public function actionEdit()
    {
        ...
        foreach ($platforms as $platform) {
            ...
            foreach ($languages as $i => $_language) {
                ...
                $page_data[$i]['c_description'] = \common\helpers\Html::textarea(
                    'description[' . $_lang_id . ']['.$platform['id'].']',
                    $data['description'] ?? '',
                    ['wrap' => 'soft', 'cols' => '70', 'rows' => '5', 'class' => 'form-control ckeditor',  'id' => 'desc'.$_lang_id.$platform['id']]
                );
                $page_data[$i]['c_description_short'] = \common\helpers\Html::textarea(
                    'description_short[' . $_lang_id . ']['.$platform['id'].']',
        ...
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('information_manager/edit'), 'title' => TEXT_EDITING . ' '.$edit_page_title.' page'];
    ...
    public function actionDeleteSelected()
    {
        ...
        $selected_ids = Yii::$app->request->getBodyParam('selected_ids', []);
    ...
    public function actionSeoproductsname($products_id)
    {
        $languages_id = \Yii::$app->settings->get('languages_id');
