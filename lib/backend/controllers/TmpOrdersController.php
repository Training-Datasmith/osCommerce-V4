...
class TmpOrdersController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['BOX_HEADING_CUSTOMERS', 'BOX_CUSTOMERS_TMP_ORDERS'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('tmporders/index'), 'title' => HEADING_TMP_ORDERS];
