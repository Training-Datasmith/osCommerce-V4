...
class Tax_ratesController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['settings', 'taxes', 'tax_rates'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('tax_rates/index'), 'title' => HEADING_TITLE];

        $this->view->headingTitle = HEADING_TITLE;
        $this->topButtons[] = '<a href="#" class="btn btn-primary" onclick="return taxEdit(0)">'.TEXT_INFO_HEADING_NEW_TAX_RATE.'</a>';

        $this->view->tax_ratesTable = [
        [
