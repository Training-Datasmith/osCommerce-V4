...
class GoogleSettingsController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['settings', 'google-settings', 'google-settings'];
        $this->navigation[] = ['link' => \Yii::$app->urlManager->createUrl('google-settings/index'), 'title' => BOX_GOOGLE_MAIN_SETTINGS];
