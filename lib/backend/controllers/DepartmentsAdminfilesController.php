...
class DepartmentsAdminfilesController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['departments', 'departments-adminfiles'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('departments-adminfiles/index'), 'title' => HEADING_TITLE];
