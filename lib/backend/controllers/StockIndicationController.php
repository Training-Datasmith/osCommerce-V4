...
class StockIndicationController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['settings', 'product_stock_indication', FILENAME_STOCK_INDICATION_INDICATION];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl(FILENAME_STOCK_INDICATION_INDICATION.'/index'), 'title' => HEADING_TITLE];
    ...
    public function actionEdit()
    {
        ...
        $this->selectedMenu = ['settings', 'product_stock_indication', FILENAME_STOCK_INDICATION_INDICATION];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl(FILENAME_STOCK_INDICATION_INDICATION.'/index'), 'title' => $title];
    ...
    public function actionSave()
    {
        ...
        if ($stock_indication_id == 0) {
            ...
            tep_db_perform(TABLE_PRODUCTS_STOCK_INDICATION, [
