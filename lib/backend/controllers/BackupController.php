...
class BackupController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['settings', 'tools', 'backup'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('backup/index'), 'title' => HEADING_TITLE];
    ...
    public function actionBackup()
    {
        ...
        if ($this->exec_gzip_available || extension_loaded('zlib')) {
            $backupHtml .= '<br>' . tep_draw_radio_field('compress', 'gzip') . ' ' . TEXT_INFO_USE_GZIP;
        }
        if ($this->exec_zip_available || extension_loaded('zip')) {
            $backupHtml .= tep_draw_radio_field('compress', 'zip') . ' ' . TEXT_INFO_USE_ZIP;
        }
    ...
    public function gzUnCompressFile($srcName, $dstName)
    {
