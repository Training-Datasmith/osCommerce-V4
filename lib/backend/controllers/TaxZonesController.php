...
class TaxZonesController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['settings', 'taxes', 'tax-zones'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('tax-zones/index'), 'title' => BOX_TAXES_GEO_ZONES];
    ...
    public function actionProductactions()
    {
        ...
        if (tep_not_null($sInfo->last_modified)) {
            echo TEXT_INFO_LAST_MODIFIED . ' ' . \common\helpers\Date::date_short($sInfo->last_modified);
        }
