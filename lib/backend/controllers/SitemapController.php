...
class SitemapController extends Sceleton
{
    ...
    public function actionIndex()
    {
        ...
        $this->selectedMenu = ['seo_cms', 'sitemap'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('sitemap/index'), 'title' => HEADING_TITLE];
        $this->view->headingTitle = HEADING_TITLE;

        $this->view->SiteMapTable = [
          [
    ...
    public function actionList()
    {
        ...
        foreach ($platformList as $platform) {
            ...
            if (empty($platform['platform_url'])) {
                ...
                $content = @file_get_contents($index_feed, false, stream_context_create([
