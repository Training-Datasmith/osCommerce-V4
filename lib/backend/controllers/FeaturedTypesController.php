...
class FeaturedTypesController extends Sceleton
{
    ...
    {
        $this->selectedMenu = ['settings', 'featured-types'];
        $this->navigation[] = ['link' => Yii::$app->urlManager->createUrl('featured-types/index'), 'title' => TEXT_FEATURED_TYPES];
