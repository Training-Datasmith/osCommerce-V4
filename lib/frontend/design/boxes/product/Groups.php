...
//                    ->select('properties_id, values_id, values_id as values_array')
            ...
            foreach ($properties_array as $id => $property) {
                ...
                $property['current_value_array'] = empty($values_for_selected_product[$id]['values_array']) ? [] : explode(',', $values_for_selected_product[$id]['values_array']) ;
            ...
            foreach ($properties_array as $prop_id1 => $prop1) {
                ...
                foreach ($values_all as $values) {
                    ...
                    foreach ($properties_array as $id2 => $prop2) {
                        ...
                        $nearest_products = $nearest_products->innerJoin(
                            \common\models\Properties2Propducts::tablename() . " $pr2p",
                    ...
                    if (!empty($nearest_products_pids)) {
                        ...
                        $properties_array[$prop_id1]['values'][$values['values_id']] = array_merge(
                            $values,
                            [
