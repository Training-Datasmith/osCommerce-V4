...
class Contacts extends Widget
{
    ...
    public static function data($name, $data, $seo)
    {
        ...
        switch ($name) {
            ...
            case 'telephone':
                if ($seo && $data[$name]) {
                    $content .= '<span itemprop="telephone">';
                }
                $content .= $data[$name];
                if ($seo && $data[$name]) {
                    $content .= '</span>';
            ...
            case 'company':
                if ($seo && $data[$name]) {
                    $content .= '<span itemprop="legalName">';
                }
                $content .= $data[$name];
                if ($seo && $data[$name]) {
                    $content .= '</span>';
            ...
            case 'postcode':
                if ($seo && $data[$name]) {
                    $content .= '<span itemprop="postalCode">';
                }
                $content .= $data[$name];
                if ($seo && $data[$name]) {
                    $content .= '</span>';
            ...
            case 'suburb':
                if ($seo && $data[$name]) {
                    $content .= '<span itemprop="addressRegion">';
                }
                $content .= $data[$name];
                if ($seo && $data[$name]) {
                    $content .= '</span>';
            ...
            case 'city':
                if ($seo && $data[$name]) {
                    $content .= '<span itemprop="addressLocality">';
                }
                $content .= $data[$name];
                if ($seo && $data[$name]) {
                    $content .= '</span>';
            ...
            case 'country':
                if ($seo && $data[$name]) {
                    $content .= '<span itemprop="addressCountry">';
                }
                $content .= $data[$name];
                if ($seo && $data[$name]) {
                    $content .= '</span>';
            ...
            case 'post_address':
                if ($seo) {
                    $content .= '<address itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">';
                }
                $address = $data;
                $address['name'] = '';
                $address['reg_number'] = '';
