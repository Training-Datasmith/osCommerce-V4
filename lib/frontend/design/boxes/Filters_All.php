...
class FiltersAll extends Widget
{
    ...
    public function run()
    {
        ...
        $filters_array[] = [
            ...
            'name' => $name,
            'type' => 'pulldown',
            'pulldown' => tep_draw_pull_down_menu($name, \common\helpers\Categories::get_categories([['id' => '', 'text' => TEXT_ALL_CATEGORIES]]), Yii::$app->request->get($name), 'class="property js-filter_param"'),
