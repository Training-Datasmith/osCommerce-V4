...
class PagingBar extends Widget
{
    ...
    public function run()
    {
        ...
        if ($listing_split->number_of_rows > 0) {
            $links = $listing_split->display_links(MAX_DISPLAY_PAGE_LINKS, \common\helpers\Output::get_all_get_params(['page', 'info', 'x', 'y', 'ajax', 't', 'filter', 'split']), $this->params['this_filename']);
