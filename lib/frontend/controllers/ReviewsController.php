    ...
    public function actionIndex()
    {
        ...
        if ($params['products_id']) {
            ...
            if (tep_db_num_rows($products_query) > 0) {
                ...
                $links = $reviews_split->display_links(MAX_DISPLAY_PAGE_LINKS, \common\helpers\Output::get_all_get_params(['page', 'info', 'x', 'y', 'ajax', 't', 'filter', 'split']), 'reviews');
    ...
    public function actionWrite()
    {
        ...
        if (isset($params['action']) && ($params['action'] == 'process') && !Yii::$app->user->isGuest) {
            ...
            if ($error == false) {
                ...
                tep_db_perform(TABLE_REVIEWS_DESCRIPTION, [
